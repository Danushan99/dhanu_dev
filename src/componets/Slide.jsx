      ...
      <div className="flex flex-col md:flex-row justify-center items-center p-20 bg-cont">
        ...
        <div className="w-full md:w-1/2 mt-4 md:mt-0 md:order-2 ">
          <div className="text-center">
            ...
            <div className="mt-4">
  <button className="box-border border border-black  text-white font-bold py-2 px-4 mr-2 hover:bg-gray-300 hover:text-gray-800 transition duration-300 ease-in-out">
    Hire Me
  </button>
